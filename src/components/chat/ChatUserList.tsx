...
export const ChatUserList: React.FC<ChatUserListProps> = ({
  ...
  return (
    <div className="bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-800 w-full md:w-64 overflow-y-auto transition-colors duration-200">
      <div className="py-4">
        <h2 className="px-4 text-lg font-semibold text-gray-800 dark:text-white mb-4">
          Messages
        </h2>
