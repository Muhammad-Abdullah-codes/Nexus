    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <Card>
          <CardBody>
            <div className="flex items-center">
              <div className="p-3 bg-purple-100 dark:bg-purple-900/50 rounded-lg mr-3">
                <TrendingUp
                  size={20}
        ...
        <Card>
          <CardBody>
            <div className="flex items-center">
              <div className="p-3 bg-indigo-100 dark:bg-indigo-900/50 rounded-lg mr-3">
                <Users
                  size={20}
        ...
        <Card>
          <CardBody>
            <div className="flex items-center">
              <div className="p-3 bg-green-100 dark:bg-green-900/50 rounded-lg mr-3">
                <Calendar
                  size={20}
