            ...
            <CardBody>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {investor.portfolioCompanies.map((company, index) => (
                  ...
                  >
                    <div className="p-3 bg-blue-50 dark:bg-blue-900/30 rounded-md mr-3">
                      <Briefcase
                        size={18}
          ...
          <Card>
            ...
            <CardBody>
              <div className="space-y-3">
                <div className="p-3 border border-gray-200 dark:border-gray-700 rounded-md bg-gray-50 dark:bg-gray-800 transition-colors">
                  <div className="flex justify-between items-center">
                    <div>
                      <h3 className="text-sm font-medium text-gray-900 dark:text-white">
                        Successful Exits
                      </h3>
                      <p className="text-xl font-semibold text-blue-700 dark:text-blue-400 mt-1">
                        4
                      </p>
                    </div>
                    <BarChart3
