              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="flex items-center mt-1">
                    <DollarSign
                      size={18}
                      className="text-indigo-600 dark:text-indigo-400 mr-1"
                    />
                ...
                <div className="pt-3 border-t border-gray-100 dark:border-gray-700">
                  ...
                  <div className="mt-2 space-y-2">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-xs bg-green-100 dark:bg-green-900/40 text-green-800 dark:text-green-400 px-2 py-0.5 rounded-full">
                        Completed
                      </span>
                    </div>
                    <div className="flex justify-between items-center">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-xs bg-yellow-100 dark:bg-yellow-900/40 text-yellow-800 dark:text-yellow-400 px-2 py-0.5 rounded-full">
                        In Progress
                      </span>
                    </div>
                  </div>
          ...
          <Card>
            ...
            <CardBody>
              <div className="space-y-3">
                <div className="flex items-center p-3 border border-gray-200 dark:border-gray-700 rounded-md hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
